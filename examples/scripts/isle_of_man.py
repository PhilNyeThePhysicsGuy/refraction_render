...
renderer = Renderer_35mm(calc,h_obs,lat_obs,lon_obs,(lat_lighthouse,lon_lighthouse),d_max,
							vert_res=2000,focal_length=2000)
renderer.render_scene(s,'lighthouse_render.png',cfunc=cfunc,cfunc_args=(621,50000),disp=True)

renderer = Renderer_Composite(calc,h_obs,lat_obs,lon_obs,d_max,
							vert_res=500,focal_length=2000,disp=True)
